  ...
  return (
    <section id="courses" className="py-20 bg-muted/30">
      <div className="container mx-auto px-4">
        ...
        {/* Hifth Section */}
        <div className="mb-16">
          <h3 className="text-3xl font-bold mb-8 text-center">Hifth</h3>
          ...
          <h4 className="text-2xl font-bold mb-8 text-center">Our courses for Hifth accommodate all tiers: 
          ...
          <div className="space-y-8 mb-12">
            <Card className="hover:shadow-lg transition-shadow duration-300">
              <CardHeader>
                ...
                <CardTitle className="text-xl">Hifth Beginner Course</CardTitle>
              </CardHeader>
              <CardContent>
                <p className="text-muted-foreground leading-relaxed mb-4">
                  After learning to read the Qur'an properly and taking the main Tajweed lessons, this is the student's first attempt at finishing the whole Qur'an Al-Kareem, to find their place besides the noble righteous scribes (in Heaven, as the Prophet PBUH mentioned). The student must take one Riwayah—one prevalent Riwayah in his country—from its prevalent Target and finish the whole Quran through it. The student agrees with his teacher on a program that he will follow, which can be developed over time, until the student completes and achieves what he wants.
                </p>
                <div className="flex items-center gap-1 text-sm text-muted-foreground">
                  <Award className="h-4 w-4" />
            ...
            <Card className="hover:shadow-lg transition-shadow duration-300">
              <CardHeader>
                ...
                <CardTitle className="text-xl">Hifth Advanced or Very Advanced Course</CardTitle>
              </CardHeader>
              <CardContent>
                <p className="text-muted-foreground leading-relaxed mb-4">
                  Here, the student is free to choose what he wants to recite by heart, i.e. narrations (Riwayāt), any readings (Qiraāt), and in any combination of them he wants. The important thing is that the student should be familiar with what he wants, knowing the rules of what he wants to read, and we will assist in that.
                </p>
                <div className="flex items-center gap-1 text-sm text-muted-foreground">
                  <Award className="h-4 w-4" />
                  Ijazah Certificate Included
